...
$my_email = "chris@thegermanfriday.com";
...
$from_email = "info@allseasonsenergysolutions.com";
...
$required_fields = array('first_name','last_name','phone','email','street_address','city','state','zip','questions');
